        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-10">
          ...
          <div className="hidden md:flex items-center justify-between">
            ...
            <Link to="/" className="block">
              <img src="/logo.png" alt="Vineet Labdhe" className="h-16 w-auto" />
            </Link>
            ...
            <div className="w-32 flex justify-end">
              <button
                ...
                className="px-6 py-2 border border-white text-white text-xs uppercase tracking-[0.2em] hover:bg-white hover:text-black transition-all duration-300"
              >
                Book Now
              </button>
            </div>
          ...
          <div className="md:hidden flex items-center justify-between">
            <Link to="/" className="block">
              <img src="/logo.png" alt="Vineet Labdhe" className="h-10 w-auto" />
            </Link>
            <button
